...
HD_PWD='E:/Code/4K-Upsampling-System-on-Zynq/src/ip_repo/upsampling/upsampling.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Upsampling_Bayes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Upsampling_Bayes.tcl -notrace
