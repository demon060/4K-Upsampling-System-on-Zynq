...
HD_PWD='E:/Code/4K-Upsampling-System-on-Zynq/src/ip_repo/upsampling/upsampling.runs/blk_mem_gen_1920_12_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_1920_12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_1920_12.tcl
