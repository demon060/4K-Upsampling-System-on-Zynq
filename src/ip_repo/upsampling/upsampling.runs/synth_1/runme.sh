...
HD_PWD='E:/Code/4K-Upsampling-System-on-Zynq/src/ip_repo/upsampling/upsampling.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Upsampling_Bayes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Upsampling_Bayes.tcl
