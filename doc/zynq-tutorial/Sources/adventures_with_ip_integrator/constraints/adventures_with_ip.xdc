...
set_property PACKAGE_PIN AB1 [get_ports {gpio_tri_io_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io_0[0]}]

set_property PACKAGE_PIN Y5 [get_ports {gpio_tri_io_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_tri_io_0[1]}]