...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXIS_to_pixel_buffer is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_buffer_count[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_buffer_count[1]_i_2\ : label is "soft_lutpair5";
...
buf_full_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes_S00_AXIS is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_empty_flag_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of fifo_empty_flag_INST_0_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \write_pointer[0]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \write_pointer[3]_i_2\ : label is "soft_lutpair3";
...
fifo_empty_flag_INST_0: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \write_pointer_reg_n_0_[3]\,
      I3 => \read_pointer_reg_n_0_[3]\,
      I4 => fifo_empty_flag_INST_0_i_1_n_0,
      O => fifo_empty_flag
    );
fifo_empty_flag_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
stream_data_fifo_reg_0_7_30_31_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A88A000000000000"
    )
        port map (
      I0 => S_AXIS_TVALID,
      I1 => S_AXIS_TREADY_INST_0_i_1_n_0,
      I2 => \read_pointer_reg_n_0_[3]\,
      I3 => \write_pointer_reg_n_0_[3]\,
      I4 => S_AXIS_ARESETN,
      I5 => mst_exec_state,
      O => fifo_wren
    );
...
writes_done_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"DFDDFFFF00000000"
    )
        port map (
      I0 => mst_exec_state,
      I1 => S_AXIS_TLAST,
      I2 => fifo_empty_flag_INST_0_i_1_n_0,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes is
  ...
  attribute C_M00_AXIS_START_COUNT of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes : entity is 32;
  attribute C_M00_AXIS_TDATA_WIDTH : integer;
  attribute C_M00_AXIS_TDATA_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes : entity is 32;
  attribute C_S00_AXIS_TDATA_WIDTH : integer;
  attribute C_S00_AXIS_TDATA_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes : entity is 32;
  attribute PIXEL_WIDTH : integer;
  attribute PIXEL_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes : entity is 24;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Upsampling_Bayes is
  ...
  signal axis_pixel_buffer_full : STD_LOGIC;
  attribute MARK_DEBUG : boolean;
  attribute MARK_DEBUG of axis_pixel_buffer_full : signal is std.standard.true;
  ...
  attribute mark_debug_string of m00_axis_tlast : signal is "true";
  attribute mark_debug_string of m00_axis_tready : signal is "true";
  attribute mark_debug_string of m00_axis_tvalid : signal is "true";
  attribute mark_debug_string of s00_axis_tlast : signal is "true";
  attribute mark_debug_string of s00_axis_tready : signal is "true";
  attribute mark_debug_string of s00_axis_tvalid : signal is "true";
  attribute mark_debug_string of m00_axis_tdata : signal is "true";
  attribute mark_debug_string of s00_axis_tdata : signal is "true";
begin
